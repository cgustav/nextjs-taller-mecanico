...
function CreateCustomer() {
  ...
  const handleOptionChange = (e: any) => {
    ...
    const validationErrors = CustomerTools.validateCustomerData({
      ...customer,
  ...
  const handleSubmit = (e: any) => {
    ...
    const validationErrors = CustomerTools.validateCustomerData(customer);
        ...
        <div>
          <form className="min-w-full">
            ...
            {customer.vehicles.length > 0 ? (
              ...
              <p>No se han agregado vehículos.</p>
            )} */}
